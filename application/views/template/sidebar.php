        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item <?= ($this->uri->segment(1) == 'event' ? 'active' : '') ?>">
                    <a href="<?= base_url('event') ?>" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-calendar-event"></i>
                        <div data-i18n="Analytics">Event</div>
                    </a>
                </li>

                <li class="menu-item <?= ($this->uri->segment(1) == 'artikel' ? 'active' : '') ?>">
                    <a href="<?= base_url('artikel') ?>" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-news"></i>
                        <div data-i18n="Analytics">Artikel</div>
                    </a>
                </li>

                <li class="menu-item <?= ($this->uri->segment(1) == 'galerry' ? 'active' : '') ?>">
                    <a href="<?= base_url('galerry') ?>" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-image-alt"></i>
                        <div data-i18n="Analytics">Galerry</div>
                    </a>
                </li>

                <li class="menu-item <?= ($this->uri->segment(1) == 'konsultasi' ? 'active' : '') ?>">
                    <a href="<?= base_url('konsultasi') ?>" class="menu-link">
                ...
                <li class="menu-item <?= ($this->uri->segment(1) == 'users' ? 'active' : '') ?>">
